...
const galleryImages = [
  '/images/Holladay_V1.png',
  '/images/Holladay_V3.png',
];

export function ProjectHolladay() {
    ...
    <main className="bg-background text-foreground">
      <section className="mx-auto max-w-7xl px-6 pb-16 pt-28 lg:px-8">
        ...
        <div className="relative overflow-hidden rounded-xl">
          <img src="/images/Holladay_V4.png" alt="Holladay hero" className="h-[560px] w-full object-cover" />
          ...
          <div className="px-4 py-5" style={{ backgroundColor: '#1a1a1a' }}>
            <div className="flex flex-wrap items-center justify-center gap-3 text-center text-xs font-semibold uppercase tracking-wider sm:text-sm">
              <span className="text-muted-foreground">
                Location: <span className="text-white">Holladay, UT</span>
              </span>
        ...
        <div className="mt-10 grid grid-cols-1 gap-4 md:grid-cols-2">
          {galleryImages.map((image, index) => (
            ...
            >
              <img
                src={image}
                alt={`Holladay gallery image ${index + 1}`}
                loading="lazy"
