    ...
    <main className="bg-background text-foreground">
      <section className="mx-auto max-w-7xl px-6 pb-16 pt-28 lg:px-8">
        ...
        <div className="relative overflow-hidden rounded-xl">
          <img
            src="/images/Cottonwood_V5.1.webp"
        ...
        <div
          className="mt-10 grid w-full grid-cols-2 gap-3 [grid-template-rows:minmax(200px,1fr)_minmax(200px,1fr)_minmax(220px,auto)]"
        >
          <button
            type="button"
            className="relative col-start-1 row-span-2 row-start-1 block h-full min-h-0 overflow-hidden rounded-xl border border-border bg-card text-left"
            onClick={() => setActiveIndex(0)}
          >
            <img
              src="/images/Cottonwood_V1.1.webp"
              alt="Cottonwood View shower"
              loading="lazy"
          ...
          <button
            type="button"
            className="relative col-start-2 row-start-1 block h-full min-h-0 overflow-hidden rounded-xl border border-border bg-card text-left"
            onClick={() => setActiveIndex(1)}
          >
            <img
              src="/images/Cottonwood_V4.1.webp"
              alt="Cottonwood View stairs"
              loading="lazy"
              className="h-full w-full object-cover transition-transform duration-300 hover:scale-[1.01]"
            />
          </button>
          <button
            type="button"
            className="relative col-start-2 row-start-2 block h-full min-h-0 overflow-hidden rounded-xl border border-border bg-card text-left"
            onClick={() => setActiveIndex(2)}
          >
            <img
              src="/images/Cottonwood_V2.1.webp"
              alt="Cottonwood View kitchen"
              loading="lazy"
              className="h-full w-full object-cover transition-transform duration-300 hover:scale-[1.01]"
            />
          </button>
          <button
            type="button"
            className="relative col-span-2 col-start-1 row-start-3 block h-full min-h-0 overflow-hidden rounded-xl border border-border bg-card text-left"
            onClick={() => setActiveIndex(3)}
          >
            <img
              src="/images/Cottonwood_V3.1.webp"
              alt="Cottonwood View living room"
              loading="lazy"
              className="h-full w-full object-cover transition-transform duration-300 hover:scale-[1.01]"
            />
          </button>
