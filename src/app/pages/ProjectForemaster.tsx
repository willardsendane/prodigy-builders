...
const galleryImages = [
  '/images/Foremaster_V6.png',
  '/images/Foremaster_V7.png',
  '/images/Foremaster_V8.webp',
  '/images/Foremaster_V9.webp',
  '/images/Foremaster_V10.webp',
  '/images/Foremaster_V11.webp',
  '/images/Foremaster_V12.webp',
  '/images/Foremaster_V13.webp',
  '/images/Foremaster_V14.webp',
  '/images/Foremaster_V15.webp',
  '/images/Foremaster_V16.webp',
  '/images/Foremaster_V17.webp',
  '/images/Foremaster_V18.webp',
  '/images/Foremaster_V19.webp',
  '/images/Foremaster_V20.webp',
  '/images/Foremaster_V21.webp',
  '/images/Foremaster_V22.webp',
  '/images/Foremaster_V23.webp',
  '/images/Foremaster_V24.webp',
  '/images/Foremaster_V25.webp',
  '/images/Foremaster_V26.webp',
  '/images/Foremaster_V27.webp',
];

export function ProjectForemaster() {
    ...
    <main className="bg-background text-foreground">
      <section className="mx-auto max-w-7xl px-6 pb-16 pt-28 lg:px-8">
        ...
        <div className="relative overflow-hidden rounded-xl">
          <img src="/images/Foremaster_V5.png" alt="Foremaster hero" className="h-[560px] w-full object-cover" />
          ...
          <div className="px-4 py-5" style={{ backgroundColor: '#1a1a1a' }}>
            <div className="flex flex-wrap items-center justify-center gap-3 text-center text-xs font-semibold uppercase tracking-wider sm:text-sm">
              <span className="text-muted-foreground">
                Location: <span className="text-white">Southern Utah</span>
              </span>
              <span className="text-muted-foreground" aria-hidden="true">
                |
              </span>
              <span className="text-muted-foreground">
                Type: <span className="text-white">Custom Home</span>
              </span>
              <span className="text-muted-foreground" aria-hidden="true">
                |
              </span>
        ...
        <div className="mt-10 columns-1 gap-4 md:columns-2 lg:columns-3">
          {galleryImages.map((image, index) => (
            ...
            >
              <img
                src={image}
                alt={`Foremaster gallery image ${index + 1}`}
                loading="lazy"
      ...
      {activeImage && (
        ...
        >
          ...
          <img
            src={activeImage}
            alt="Foremaster lightbox preview"
