...
const galleryImages = [
  '/images/TraverseOutlook_V2.png',
  '/images/TraverseOutlook_V4.png',
];

export function ProjectTraverse() {
    ...
    <main className="bg-background text-foreground">
      <section className="mx-auto max-w-7xl px-6 pb-16 pt-28 lg:px-8">
        ...
        <div className="relative overflow-hidden rounded-xl">
          <img
            src="/images/TraverseOutlook_V1.png"
            alt="Traverse Outlook hero"
        ...
        <div className="mt-10 grid grid-cols-2 gap-4">
          {galleryImages.map((image, index) => (
            ...
            >
              <img
                src={image}
                alt={`Traverse Outlook gallery image ${index + 1}`}
                loading="lazy"
      ...
      {activeImage && (
        ...
        >
          ...
          <img
            src={activeImage}
            alt="Traverse Outlook lightbox preview"
