...
const galleryImages = [
  '/images/Hurricane_V2.png',
  '/images/Hurricane_V4.png',
  '/images/Hurricane_V1.png',
  '/images/Hurricane_1.avif',
  '/images/Hurricane_9.avif',
  '/images/Hurricane_10.avif',
  '/images/Hurricane_11.avif',
  '/images/Hurricane_12.avif',
  '/images/Hurricane_14.avif',
  '/images/Hurricane_17.avif',
  '/images/Hurricane_22.avif',
  '/images/Hurricane_24.avif',
  '/images/Hurricane_25.avif',
  '/images/Hurricane_32.avif',
  '/images/Hurricane_35.avif',
  '/images/Hurricane_38.avif',
  '/images/Hurricane_39.avif',
  '/images/Hurricane_44.avif',
  '/images/Hurricane_45.avif',
  '/images/Hurricane_47.avif',
  '/images/Hurricane_51.avif',
];

export function ProjectHurricane() {
    ...
    <main className="bg-background text-foreground">
      <section className="mx-auto max-w-7xl px-6 pb-16 pt-28 lg:px-8">
        ...
        <div className="relative overflow-hidden rounded-xl">
          <img
            src="/images/Hurricane_hero.png"
            alt="Hurricane Retreat hero"
          ...
          <div className="px-4 py-5" style={{ backgroundColor: '#1a1a1a' }}>
            <div className="flex flex-wrap items-center justify-center gap-3 text-center text-xs font-semibold uppercase tracking-wider sm:text-sm">
              <span className="text-muted-foreground">
                Location: <span className="text-white">Hurricane, UT</span>
              </span>
        ...
        <div className="mt-10 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
          {galleryImages.map((image, index) => (
            ...
            >
              <img
                src={image}
                alt={`Hurricane Retreat gallery image ${index + 1}`}
                loading="lazy"
      ...
      {activeImage && (
        ...
        >
          ...
          <img
            src={activeImage}
            alt="Hurricane Retreat lightbox preview"
