  ...
  return (
    <section className="relative py-32 w-full flex items-center justify-center bg-[#0a0a0a] border-b border-white/5">
      <div className="container mx-auto px-6 lg:px-12 text-center">
        <h1 className="text-center tracking-wide mb-6 text-[3.375rem] sm:text-5xl md:text-7xl lg:text-8xl xl:text-[120px] max-md:text-[2.619rem]" style={{ fontWeight: 900, lineHeight: 1.1 }}>
          Build Better. <span style={{ color: '#C9A84C' }}>Build Prodigy.</span>
        </h1>
