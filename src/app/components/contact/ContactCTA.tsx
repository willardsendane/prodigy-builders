  ...
  return (
    <section className="bg-[#0a0a0a] py-20 border-b border-white/5">
      <div className="container mx-auto px-6 lg:px-12 text-center">
        <h2 className="text-2xl md:text-3xl mb-8 tracking-tight font-['Blair_ITC']" style={{ fontWeight: 900 }}>
          Prefer to reach out directly?
        </h2>
        <p className="text-foreground/80 mb-8 max-w-xl mx-auto tracking-wide">
